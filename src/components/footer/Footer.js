  ...
  return (
    <div className="bg-dark pt-4">
      <Container>
        ...
        <Row>
          <Col xs={12} md={8}>
            <h4 className="text-info fw-bolder t"> <span className="text-success">Online</span> HealthCare </h4>
          </Col>
          <Col xs={6} md={4}>
        ...
        <Row className="text-light">
          ...
          <Col xs={6} md={4}>
            <Image className="w-75" src="https://content.fortune.com/wp-content/uploads/2020/01/BIG.02.20.Health-Care-.jpg" roundedCircle />
